...
'''
Extract data from the released MIMIC-Extract file, given a predefined cohort.
'''
...
def main():
    ...
    df_train, df_dev, df_test = prepare_data_with_splits_orig(df, args.window_size, *cohort_stays)
...
def prepare_data_with_splits_orig(df, WINDOW_SIZE, train_stay, dev_stay, test_stay):
    '''
    stays: icustay_id
    raw_data: df loaded from released mimic-extract file
