...
def main():
    ...
    # else:
    #     list_raw_datasets = [
    #         datasets.load_from_disk(dataset_path=os.path.join(data_args.dataset_dir, dataset_name))
    ...
    ### -----------------------
    training_args = update_output_dir(training_args, model_args, data_args, 'NER')
